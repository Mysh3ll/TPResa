<?php
/**
 * Vue ModificationEvenementClient.php
 * Permet à l'utilisateur de modifier les places résrvées
            ...
            <div class="col-lg-12">
                <form id="inscriptionEvent" class="form-horizontal" method="post" >
                    <fieldset>
                        ...
                        <!-- Form Name -->
                        <legend><h1>Nombre de places réservées</h1></legend>

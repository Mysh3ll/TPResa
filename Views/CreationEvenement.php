...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form class="form-horizontal" action="CreationEvent.php" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="TitreEvent" name="TitreEvent" placeholder="Titre événement"
                                       class="form-control input-md" required="" type="text" onblur="this.value=this.value.Majuscule()">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="TitreEvent">Date de l'événement</label>
                               ...
                               <div class="col-md-4" id="datepicker"><input type="text" hidden value="" id="inputDate" name="inputDate"/></div>
